...
import "../../style/userComplaintDetails.css";
import {
  FaRegUser,
  FaFileAlt,
  FaCheckCircle,
...
const UserComplaintDetails = () => {
  ...
  const investigatorAssigned = true;
  const noteAdded = true;
          ...
          <div className="col-lg-8">
            <div className="detailBox">
              <div className="topHeader">
                ...
                <span className="statusBadge pending">{complaint.status}</span>
              </div>
