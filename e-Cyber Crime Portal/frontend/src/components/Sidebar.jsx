...
const Sidebar = () => {
  ...
  const menuListDataTwo = [
    {id : 1 , path : "/auth/signup" , text : "Register" , icon : <FaRegUser />},
    {id : 2 , path : "/auth/signin" , text : "Sign in" , icon : <IoIosLogIn />},
  ]

  return (
    <div className='SideBarMainContainer pt-3'>
      <div className="sideBarHeader d-flex mb-3 ps-4 pb-3 pe-4">
      ...
      <div className="sidebarMenuList ps-4 pe-4">
          ...
          {menuListData.map((el)=>(
            <NavLink to={el.path} className={({isActive})=>isActive ? "navMenu active" : "navMenu"}>
              <section>
